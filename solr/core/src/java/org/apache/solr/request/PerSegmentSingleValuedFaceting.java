...
class CountSortedFacetCollector extends FacetCollector {
  ...
  final int limit;
  final int maxsize;
  final BoundedTreeSet<org.apache.solr.request.SimpleFacets.CountPair<String,Integer>> queue;
  ...
  public NamedList<Integer> getFacetCounts() {
    ...
    int lim=limit>=0 ? limit : Integer.MAX_VALUE;
     ...
     for (org.apache.solr.request.SimpleFacets.CountPair<String,Integer> p : queue) {
       if (--off>=0) continue;
       if (--lim<0) break;
       res.add(p.key, p.val);
     }
