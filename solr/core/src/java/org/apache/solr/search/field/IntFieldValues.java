...
public class IntFieldValues extends FieldValues {
  ...
  @Override
  public IntLeafValues getValues(QueryContext context, AtomicReaderContext readerContext) throws IOException {
    return (IntLeafValues) super.getValues(context, readerContext);
  }
