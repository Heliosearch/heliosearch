...
/**
 * Tests of deep paging using {@link CursorMark} and CURSOR_MARK_PARAM.
 */
public class CursorPagingTest extends SolrTestCaseJ4 {
  ...
  /**
   * Given a set of params, executes a cursor query using CURSOR_MARK_START
   * and then continuously walks the results using CURSOR_MARK_START as long
   ...
   * CURSOR_MARK_NEXT value from the response
   *
   * @see #assertJQ
   */
