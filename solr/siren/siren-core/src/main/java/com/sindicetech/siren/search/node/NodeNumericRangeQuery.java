...
/**
 * A {@link DatatypedNodeQuery} that matches numeric values within a
 * specified range.
 *
 * <p>
 *
 ...
 **/
public class NodeNumericRangeQuery<T extends Number> extends MultiNodeTermQuery {

  protected String termPrefix;

  protected NodeNumericRangeQuery(final String field, final int precisionStep,
    ...
    termPrefix = dataType.toString() + precisionStep;
...
//        );
  ...
  /**
   * Factory that creates a {@link NodeNumericRangeQuery}, that queries a <code>long</code>
  ...
  /**
   * Factory that creates a {@link NodeNumericRangeQuery}, that queries a <code>int</code>
   * range using the given <a href="#precisionStepDesc"><code>precisionStep</code></a>.
   * You can have half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries)
   * by setting the min or max value to <code>null</code>. By setting inclusive to false, it will
   * match all documents excluding the bounds, with inclusive on, the boundaries are hits, too.
  ...
  /**
   * Factory that creates a {@link NodeNumericRangeQuery}, that queries a <code>double</code>
   * range using the given <a href="#precisionStepDesc"><code>precisionStep</code></a>.
   * You can have half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries)
   * by setting the min or max value to <code>null</code>. By setting inclusive to false, it will
   * match all documents excluding the bounds, with inclusive on, the boundaries are hits, too.
  ...
  /**
   * Factory that creates a {@link NodeNumericRangeQuery}, that queries a <code>float</code>
   * range using the given <a href="#precisionStepDesc"><code>precisionStep</code></a>.
   * You can have half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries)
   * by setting the min or max value to <code>null</code>. By setting inclusive to false, it will
   * match all documents excluding the bounds, with inclusive on, the boundaries are hits, too.
        ...
        case DOUBLE: {
          ...
          NumericUtils.splitLongRange(new NumericUtils.LongRangeBuilder() {
            ...
            public final void addRange(final BytesRef minPrefixCoded, final BytesRef maxPrefixCoded) {
              final BytesRef min = new BytesRef(termPrefix);
              min.append(minPrefixCoded);
              final BytesRef max = new BytesRef(termPrefix);
