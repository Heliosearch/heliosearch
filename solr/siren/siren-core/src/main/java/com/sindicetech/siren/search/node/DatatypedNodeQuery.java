...
/**
 * A {@link com.sindicetech.siren.search.node.Datatyped} {@link NodeQuery}, such as {@link NodeTermQuery}.
 */
public abstract class DatatypedNodeQuery extends NodeQuery implements Datatyped {
  ...
  /**
   * Get the datatype associated with this query.
   */
