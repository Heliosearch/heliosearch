 ...
 */
public class ChildPropertyParser extends AbstractClausePropertyParser {
  ...
  @Override
  protected ModifierQueryNode newClauseQueryNode(final QueryNode node, final Modifier mod) {
    return new ChildQueryNode(node, mod);
  }
