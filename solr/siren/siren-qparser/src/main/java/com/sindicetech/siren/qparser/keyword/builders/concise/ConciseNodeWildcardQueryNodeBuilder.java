...
import com.sindicetech.siren.qparser.keyword.builders.NodeWildcardQueryNodeBuilder;
...
/**
 * An extension of the {@link com.sindicetech.siren.qparser.keyword.builders.NodeWildcardQueryNodeBuilder} that will prepend
 ...
 * of the {@link org.apache.lucene.queryparser.flexible.standard.nodes.WildcardQueryNode} before delegating the construction
 * of the {@link com.sindicetech.siren.search.node.NodeQuery} to the original
 * {@link com.sindicetech.siren.qparser.keyword.builders.NodeWildcardQueryNodeBuilder}.
 */
public class ConciseNodeWildcardQueryNodeBuilder extends NodeWildcardQueryNodeBuilder {

  private final QueryConfigHandler conf;

  private final StringBuilder builder = new StringBuilder();

  public ConciseNodeWildcardQueryNodeBuilder(final QueryConfigHandler queryConf) {
    this.conf = queryConf;
  }
  ...
  public NodeWildcardQuery build(final QueryNode queryNode) throws QueryNodeException {
    ...
    return super.build(wildcardNode);
  }
