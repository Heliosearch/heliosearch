...
import com.sindicetech.siren.qparser.keyword.builders.NodeRegexpQueryNodeBuilder;
...
/**
 * An extension of the {@link com.sindicetech.siren.qparser.keyword.builders.NodeRegexpQueryNodeBuilder} that will prepend
 ...
 * of the {@link org.apache.lucene.queryparser.flexible.standard.nodes.RegexpQueryNode} before delegating the construction
 * of the {@link com.sindicetech.siren.search.node.NodeQuery} to the original
 * {@link com.sindicetech.siren.qparser.keyword.builders.NodeRegexpQueryNodeBuilder}.
 */
public class ConciseNodeRegexpQueryNodeBuilder extends NodeRegexpQueryNodeBuilder {

  private final QueryConfigHandler conf;

  private final StringBuilder builder = new StringBuilder();

  public ConciseNodeRegexpQueryNodeBuilder(final QueryConfigHandler queryConf) {
    this.conf = queryConf;
  }
  ...
  public NodeQuery build(final QueryNode queryNode) throws QueryNodeException {
    if (conf.has(ConciseKeywordQueryConfigHandler.ConciseKeywordConfigurationKeys.ATTRIBUTE)) {
      ...
      ConciseNodeBuilderUtil.prepend(builder, attribute, regexpNode);
    }
